...
from core.persistence import get_elastic, get_redis
from core.tests import ConversationTest, ConversationTestRecorder, ConversationTestException, TestLog, \
    UserTextMessage
...
class GActionsView(generic.View):
    ...
    def post(self, request, *args, **kwargs):
        from core.interfaces.gactions import GActionsInterface
